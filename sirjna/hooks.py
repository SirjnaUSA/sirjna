...
doc_events = {
    "Payment Request": {
        "on_update": "sirjna.sirjna.integrations.payments.handle_payment_request_update"
    }
}

after_migrate = [
    "sirjna.install.bootstrap_everything",
    "sirjna.sirjna_appointments.install.bootstrap"
]

app_include_js = [
    "/assets/sirjna/sirjna_appointments/js/book_call.js"
]